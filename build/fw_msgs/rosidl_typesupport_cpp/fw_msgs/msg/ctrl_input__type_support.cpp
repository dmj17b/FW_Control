...
static const _CtrlInput_type_support_symbol_names_t _CtrlInput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fw_msgs, msg, CtrlInput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fw_msgs, msg, CtrlInput)),
  }
};
...
{
  return &::fw_msgs::msg::rosidl_typesupport_cpp::CtrlInput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fw_msgs, msg, CtrlInput)() {
  return get_message_type_support_handle<fw_msgs::msg::CtrlInput>();
}
