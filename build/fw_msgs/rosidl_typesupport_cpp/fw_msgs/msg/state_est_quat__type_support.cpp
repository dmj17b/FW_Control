...
static const _StateEstQuat_type_support_symbol_names_t _StateEstQuat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fw_msgs, msg, StateEstQuat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fw_msgs, msg, StateEstQuat)),
  }
};
...
{
  return &::fw_msgs::msg::rosidl_typesupport_cpp::StateEstQuat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fw_msgs, msg, StateEstQuat)() {
  return get_message_type_support_handle<fw_msgs::msg::StateEstQuat>();
}
