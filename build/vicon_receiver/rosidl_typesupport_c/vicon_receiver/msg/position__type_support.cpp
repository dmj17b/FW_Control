...
#include "vicon_receiver/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Position_type_support_symbol_names_t _Position_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vicon_receiver, msg, Position)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vicon_receiver, msg, Position)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_vicon_receiver
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vicon_receiver, msg, Position)() {
  return &::vicon_receiver::msg::rosidl_typesupport_c::Position_message_type_support_handle;
}
